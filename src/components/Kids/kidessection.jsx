    ...
    <section className="py-16 md:py-24 bg-white text-center overflow-hidden">
      ...
      <div className="mb-12 md:mb-16 px-4">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
          Discover our playful collection that combines <span className="text-primary font-medium">comfort, style, and fun</span> for your little ones
        </p>
      </div>
