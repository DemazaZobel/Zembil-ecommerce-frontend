      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {cards.map((card) => (
          <Link
            key={card.title}
            to={card.link}
            className="bg-primary hover:bg-secondary transition transform hover:scale-105 duration-300 text-white p-6 rounded-2xl shadow-2xl flex flex-col items-center justify-center font-semibold text-lg"
          >
